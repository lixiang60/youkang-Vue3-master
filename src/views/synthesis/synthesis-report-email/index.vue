...
<script setup name="SynthesisReportEmail">
...
const columns = ref([
  ...
  { prop: 'id', label: '标示', minWidth: 100, fixed: true, visible: true },
  { prop: 'salesman', label: '销售员', minWidth: 100, visible: true },
  { prop: 'customerId', label: '客户ID', minWidth: 100, visible: true },
  { prop: 'customerName', label: '客户姓名', minWidth: 120, visible: true },
  { prop: 'orderId', label: '订单号', minWidth: 150, visible: true },
  { prop: 'plateNo', label: '版号', minWidth: 120, visible: true },
  { prop: 'emailTitle', label: '邮件标题', minWidth: 240, showOverflowTooltip: true, visible: true },
  { prop: 'fileSize', label: '文件大小', minWidth: 110, visible: true },
  { prop: 'attachUrl', label: '附件地址', minWidth: 180, showOverflowTooltip: true, visible: true },
  { prop: 'isSend', label: '是否发送', minWidth: 100, visible: true },
  ...
  { prop: 'downloadUrl', label: '下载', minWidth: 90, slot: 'download', visible: true },
  { prop: 'sendBy', label: '发送人', minWidth: 110, visible: true },
  { prop: 'sendTime', label: '发送时间', minWidth: 180, visible: true },
  { prop: 'sendResult', label: '发送结果', minWidth: 110, visible: true },
  { prop: 'failureReason', label: '失败原因', minWidth: 180, showOverflowTooltip: true, visible: true },
  { prop: 'companyName', label: '所属公司', minWidth: 160, visible: true }
])
