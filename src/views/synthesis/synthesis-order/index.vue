<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button v-hasPermi="['synthesis:order:add']" size="small" type="success" plain icon="Plus" @click="handleAdd"
          >添加</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          v-hasPermi="['synthesis:order:edit']"
          size="small"
          type="primary"
          plain
          icon="Edit"
      ...
      <el-col :span="1.5">
        <el-button
          v-hasPermi="['synthesis:order:remove']"
          size="small"
          type="danger"
          plain
          icon="Delete"
