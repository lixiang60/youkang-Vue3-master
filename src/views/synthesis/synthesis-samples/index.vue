...
<script setup name="SynthesisSamples">
...
const columns = ref([
  ...
  { prop: 'orderHistory', label: '历史订单', minWidth: 160, visible: true },
  { prop: 'sampleId', label: '样品编号', minWidth: 130, fixed: true, visible: true },
  { prop: 'sampleType', label: '样品类型', minWidth: 100, visible: true },
  { prop: 'samplePosition', label: '样品位置', minWidth: 100, visible: true },
  { prop: 'primer', label: '测序引物', minWidth: 110, visible: true },
  { prop: 'primerType', label: '引物类型', minWidth: 100, visible: true },
  { prop: 'primerPosition', label: '引物位置', minWidth: 100, visible: true },
  { prop: 'primerConcentration', label: '引物浓度', minWidth: 100, visible: true },
  { prop: 'seq', label: '序列', minWidth: 180, showOverflowTooltip: true, visible: true },
  { prop: 'project', label: '测序项目', minWidth: 110, visible: true },
  { prop: 'carrierName', label: '载体名称', minWidth: 120, visible: true },
  { prop: 'antibioticType', label: '抗生素类型', minWidth: 110, visible: true },
  { prop: 'plasmidLength', label: '质粒长度', minWidth: 100, visible: true },
  { prop: 'fragmentSize', label: '片段大小', minWidth: 100, visible: true },
  { prop: 'testResult', label: '是否测通', minWidth: 100, visible: true },
  { prop: 'originConcentration', label: '原浓度', minWidth: 100, visible: true },
  { prop: 'templatePlateNo', label: '模板板号', minWidth: 110, visible: true },
  { prop: 'templateHoleNo', label: '模板孔号', minWidth: 100, visible: true },
  { prop: 'performance', label: '完成情况', minWidth: 100, visible: true },
  { prop: 'returnState', label: '返回状态', minWidth: 100, visible: true },
  { prop: 'flowName', label: '流程名称', minWidth: 130, visible: true },
  { prop: 'plateNo', label: '板号', minWidth: 110, visible: true },
  { prop: 'holeNo', label: '孔号', minWidth: 100, visible: true },
  { prop: 'belongCompany', label: '所属公司', minWidth: 140, visible: true },
  { prop: 'produceCompany', label: '生产公司', minWidth: 140, visible: true },
  { prop: 'holeNumber', label: '孔号数量', minWidth: 100, visible: true },
  { prop: 'layout', label: '排版方式', minWidth: 100, visible: true },
  { prop: 'createUser', label: '创建人', minWidth: 110, visible: true },
  { prop: 'createTime', label: '完成时间', minWidth: 180, visible: true },
