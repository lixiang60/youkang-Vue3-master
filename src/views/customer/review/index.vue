<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button v-hasPermi="['customer:review:audit']" size="small" type="warning" :icon="Key" @click="handleReview"
          >审核</el-button
        >
      </el-col>
      <el-col :span="1.5">
...
import { Search, Refresh, Key, FolderChecked, Delete } from '@element-plus/icons-vue'
