<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button size="small" type="primary" plain :icon="Stamp" :disabled="multiple" @click="handleAudit"
          >审核</el-button
        >
      </el-col>
...
<script setup name="OrderConfirm">
import { ref, reactive, toRefs, onMounted, getCurrentInstance } from 'vue'
import { Search, Refresh, Stamp } from '@element-plus/icons-vue'
...
function handleAudit() {
  if (ids.value.length === 0) {
    proxy.$modal.msgWarning('请选择要审核的订单')
    return
  }
  proxy.$modal
    .confirm(`确认审核选中的 ${ids.value.length} 条订单记录？`)
    .then(() => {
