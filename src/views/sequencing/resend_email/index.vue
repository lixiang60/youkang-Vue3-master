...
const columns = ref([
  ...
  { prop: 'productionNo', label: '生产编号', minWidth: 120, fixed: true, sortable: true, visible: true },
  ...
  { prop: 'researchGroup', label: '课题组', minWidth: 140, showOverflowTooltip: true, visible: true },
  ...
  { prop: 'performance', label: '完成情况', minWidth: 110, visible: true },
  ...
  { prop: 'templatePlateNo', label: '板号', minWidth: 110, visible: true },
