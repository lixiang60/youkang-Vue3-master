...
const columns = ref([
  ...
  { prop: 'reagent', label: '试剂', minWidth: 100, visible: true },
  { prop: 'urgent', label: '加急', minWidth: 80, visible: true },
  { prop: 'sampleId', label: '样品编号', minWidth: 120, visible: true },
  { prop: 'primer', label: '测序引物', minWidth: 120, visible: true },
  { prop: 'primerConcentration', label: '引物浓度', minWidth: 90, visible: true },
  { prop: 'sampleType', label: '样品类型', minWidth: 90, visible: true },
  { prop: 'antibioticType', label: '抗生素类型', minWidth: 110, visible: true },
  { prop: 'isAsync', label: '是否测试', minWidth: 90, visible: true },
  { prop: 'originConcentration', label: '原浓度', minWidth: 100, visible: true },
  { prop: 'produceStatus', label: '完成情况', minWidth: 120, visible: true },
  { prop: 'returnState', label: '退回状态', minWidth: 120, visible: true },
  { prop: 'remark', label: '备注', minWidth: 200, showOverflowTooltip: true, visible: true },
  { prop: 'flowId', label: '流程ID', minWidth: 100, visible: true },
  { prop: 'flowName', label: '流程名称', minWidth: 100, visible: true }
])
