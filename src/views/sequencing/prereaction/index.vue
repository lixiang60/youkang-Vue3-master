...
const columns = ref([
  ...
  { key: 'sampleId', label: '样品编号', minWidth: 130, fixed: true, sortable: true, visible: true },
  { key: 'primer', label: '测序引物', minWidth: 130, visible: true },
  { key: 'primerName', label: '引物', minWidth: 100, visible: true },
  ...
  { key: 'plateNo', label: '模板板号', minWidth: 130, visible: true },
  { key: 'holeNo', label: '模板孔号', minWidth: 110, visible: true },
  { key: 'carrierName', label: '载体名称', minWidth: 120, visible: true },
  { key: 'produceId', label: '生产编号', minWidth: 120, sortable: true, visible: true },
  ...
  { key: 'completionStatus', label: '是否测通', minWidth: 110, visible: true },
  { key: 'prevPlateNo', label: '上一版号', minWidth: 130, visible: true },
  { key: 'customerName', label: '客户姓名', minWidth: 110, visible: true },
  { key: 'customerAddress', label: '客户地址', minWidth: 220, showOverflowTooltip: true, visible: true },
  { key: 'topic', label: '课题组', minWidth: 140, visible: true },
  { key: 'priority', label: '加急', minWidth: 80, visible: true },
